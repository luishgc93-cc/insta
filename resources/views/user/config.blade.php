...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><center><h3>Configuración de mi cuenta </h3> </center></div>



                <div class="card-body">
                    <form method="POST" action="{{ route('user.update') }}" aria-label="Configuración" enctype="multipart/form-data">
                        @csrf
